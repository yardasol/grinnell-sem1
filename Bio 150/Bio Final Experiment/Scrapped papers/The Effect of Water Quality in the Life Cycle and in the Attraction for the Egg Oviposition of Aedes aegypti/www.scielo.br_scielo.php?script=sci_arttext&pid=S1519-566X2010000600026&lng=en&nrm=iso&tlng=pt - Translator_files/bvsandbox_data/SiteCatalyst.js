...
var s_account = "mswlsrccrmmsfttranslator";
...
s.linkDownloadFileTypes = "exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx,msi";
s.linkInternalFilters = "javascript:,bing.com";
...
s_doPlugins(s) {
    ...
    s.prop3=s.getVisitNum();
    s.eVar3 = s.prop3;

    s.prop4=s.getNewRepeat();
    s.eVar4 = s.prop4;

    s.eVar5=s.getQueryParam('form');
    s.eVar5=s.getValOnce(s.eVar5,"s_eVar5",0);
    s.prop5 = s.eVar5;

    s.eVar6=s.getQueryParam('publ');
    s.eVar6=s.getValOnce(s.eVar6,"s_eVar6",0);
    s.prop6 = s.eVar6;

    s.eVar7=s.getQueryParam('crea');
